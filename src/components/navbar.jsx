...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* Mobile Menu */}
      {open && (
        <div className="fixed top-[20px] left-4 right-4 h-[80vh] z-51 bg-blue-900/70 backdrop-blur-md rounded-2xl shadow-lg p-4 flex flex-col items-center justify-center gap-4 md:hidden">
